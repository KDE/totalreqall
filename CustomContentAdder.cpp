      ...
      m_content{ new QTextEdit }
{
	...
	connect(buttons->button(QDialogButtonBox::Ok), &QPushButton::clicked, this, &CustomContentAdder::ok);
	connect(buttons->button(QDialogButtonBox::Cancel), &QPushButton::clicked, this, &CustomContentAdder::cancel);
